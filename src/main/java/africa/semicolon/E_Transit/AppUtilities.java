...
public class AppUtilities {
    ...
    public static final String WELCOME_MAIL_TEMPLATE_LOCATION = "C:\\Users\\user\\Downloads\\uberdeluxe\\uberdeluxe\\src\\main\\resources\\welcome.txt";

    public static final String EMAIL_REGEX_STRING = "^[A-Za-z0-9+_.-]+@(.+)$";

    public static final String ADMIN_INVITE_MAIL_TEMPLATE_LOCATION = "C:\\Users\\user\\Downloads\\uberdeluxe\\uberdeluxe\\src\\main\\resources\\adminMail.txt";
